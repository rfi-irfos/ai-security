<p align="center">
   ...
   <p align="center">
      <img src="/src/fuzzyai/resources/logo.[REDACTED]" alt="Project Logo" width="200" style="vertical-align:middle; margin-right:10px;" /><br/>
...
<p align="center">
   <a href="[URL_REDACTED]">
      <img alt="GitHub last commit" src="https://img.shields.io/github/last-commit/[REDACTED]/fuzzyai">
   </a>
   <a href="[URL_REDACTED]">
      <img alt="GitHub code size in bytes" src="https://img.shields.io/github/languages/code-size/[REDACTED]/FuzzyAI">
   </a>
   <a href="[URL_REDACTED]" >
      <img alt="GitHub License" src="https://img.shields.io/github/license/[REDACTED]/fuzzyai">
   </a>
   <ahref="[LINK_REDACTED]">
...
1. Clone the repository:
   ```bash
   git clone git@github.com:[REDACTED]/FuzzyAI.git
   cd FuzzyAI
   ```
...
## Notebooks
We've included interactive Jupyter notebooks you can use under [src/fuzzyai/resources/notebooks/]([URL_REDACTED]  
For more information, see [notebooks wiki]([URL_REDACTED]

## Datasets

We've included some datasets you can use under [resources/]([URL_REDACTED] For more information, see [datasets wiki]([URL_REDACTED]

## Documentation

Explore detailed usage instructions in the [Wiki]([URL_REDACTED]
...
Easily add support for additional models by following our <a href="[URL_REDACTED]">DIY guide</a>.

## Implemented Attacks
See <a href="[URL_REDACTED]">attacks wiki</a> for detailed information
...
| DAN (Do Anything Now)                        | Promotes the LLM to adopt an unrestricted persona that ignores standard content filters, allowing it to "Do Anything Now".                                                  | [GitHub Repo]([URL_REDACTED]                            |
...
Contributions are welcome! If you would like to contribute to the FuzzyAI Fuzzer, please follow the guidelines outlined in the [CONTRIBUTING.md]([URL_REDACTED] file.

## License

The FuzzyAI Fuzzer is released under the [Apache License](https://www.apache.org/licenses/LICENSE-2.0). See the [LICENSE]([URL_REDACTED] file for more details.

## Contact

If you have any questions or suggestions regarding the FuzzyAI Fuzzer, please feel free to contact us at [fzai@[REDACTED].com](mailto:fzai@[REDACTED].com).
