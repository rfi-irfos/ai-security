...
![ci]([URL_REDACTED]
![GitHub contributors](https://img.shields.io/github/contributors/[REDACTED]/ps-fuzz)
![Last release](https://img.shields.io/github/v/release/[REDACTED]/ps-fuzz)
...
<h4> Brought to you by [REDACTED], the Complete Platform for GenAI Security
...
![[REDACTED] Logo](./resources/Black+Color.png)
...
* [ :rocket: Installation](#installation)
    * [Using pip](#using-pip)
    * [Package page](https://pypi.org/project/[REDACTED]-fuzzer/)
...
<a id="installation"></a>
## 🚀 Installation 
![prompt-fuzzer-install-final]([URL_REDACTED]
...
1. Install the Fuzzer package
   ...
   ```zsh
   pip install [REDACTED]-fuzzer
   ```
   <a id="using-pypi"></a>
   #### Using the package page on PyPi
   You can also visit the [package page](https://pypi.org/project/[REDACTED]-fuzzer/) on PyPi

   Or grab latest release wheel file form [releases]([URL_REDACTED]
...
System prompt examples (of various strengths) can be found in the subdirectory [system_prompt.examples]([URL_REDACTED] in the sources.
...
```
    [REDACTED]-fuzzer -b ./system_prompt.examples/medium_system_prompt.txt
```
...
```
    [REDACTED]-fuzzer -b ./system_prompt.examples/medium_system_prompt.txt --custom-benchmark=ps_fuzz/attack_data/custom_benchmark1.csv
```
...
```
    [REDACTED]-fuzzer -b ./system_prompt.examples/medium_system_prompt.txt --custom-benchmark=ps_fuzz/attack_data/custom_benchmark1.csv --tests='["ucar","amnesia"]'
```
...
**Note**: Requires chromadb (installed by default with [REDACTED]-fuzzer)
...
Turn this into a community project! We want this to be useful to everyone building GenAI applications. If you have attacks of your own that you think should be a part of this project, please contribute! This is how: [URL_REDACTED]

<a id="contributing"></a>
## 🍻 Contributing

Interested in contributing to the development of our tools? Great! For a guide on making your first contribution, please see our [Contributing Guide]([URL_REDACTED] This section offers a straightforward introduction to adding new tests.
