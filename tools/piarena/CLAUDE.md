...
Datasets load from local JSON in `datasets/` first, falling back to HuggingFace (`[REDACTED]/PIArena`). 17 datasets covering QA, summarization, extraction, long-context, and knowledge corruption tasks.
