...
| - | - | - |
| [TrustyAI Garak]([URL_REDACTED] | Apache |  Out-of-Tree Llama Stack Eval Provider for Garak Red Teaming |
| [Garak-MCP]([URL_REDACTED] | MIT license | MCP Server for garak |
| [Garak Report]([URL_REDACTED] | Apache-2.0 | A repository for your Garak runs, as well as a modern visualizer. |

<!-- * [Garak Studio]([URL_REDACTED] - OSS GUI for garak -->
...
Inclusion on this page does not imply an endorsement by the maintainers or [REDACTED].
