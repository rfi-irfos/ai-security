...
-->
<p align="center">
<img src="docs/img/logo.[REDACTED]" alt="Cryptex OSS" width="7%">
...
<p align="center">
  ...
  <a href="[URL_REDACTED]"><img src="https://img.shields.io/github/v/release/[REDACTED]/cryptex-oss?label=release&color=9b59b6" alt="latest release"></a>
  <a href="CHANGELOG.md"><img src="https://img.shields.io/badge/changelog-keep--a--changelog-orange.svg" alt="Changelog"></a>
  <a href="[URL_REDACTED]"><img src="https://img.shields.io/badge/ghcr-cryptex--oss-2496ed.svg?logo=docker&logoColor=white" alt="GHCR image"></a>
  <a href="[URL_REDACTED]"><img src="[URL_REDACTED]" alt="Docker build"></a>
</p>
...
<p align="center">
  <a href="https://[REDACTED].github.io/cryptex-oss/transforms/"><strong>Try Online→</strong></a>
  &nbsp;·&nbsp;
...
docker run -d --name cryptex --restart unless-stopped \
  -p 8080:80 ghcr.io/[REDACTED]/cryptex-oss:latest
```
...
services:
  cryptex:
    image: ghcr.io/[REDACTED]/cryptex-oss:latest
...
- **Local providers, no key needed**: Ollama, LM Studio, vLLM, llama.cpp, Llamafile, [REDACTED] NIM. Point at the local URL (`http://localhost:11434`, etc.) and Cryptex skips the key requirement.
...
<p align="left">
  <strong>Source:</strong> <a href="[URL_REDACTED]">github.com/[REDACTED]/cryptex-oss</a>
  <br>
  <strong>Recipes:</strong> <a href="docs/USAGE.md">docs/USAGE.md</a>
  <br>
  <strong>Sibling product:</strong> <ahref="[LINK_REDACTED]">cryptex.m4xx.cfd</a> (chat playground, attack-chain composer; separate codebase)
</p>

> P.S. — A tip of the hat to [elder-plinius/P4RS3LT0NGV3]([URL_REDACTED] every model in this toolkit was already jailbroken there before our `npm install` finished, so consider Cryptex OSS the release engineering on his hobby.
