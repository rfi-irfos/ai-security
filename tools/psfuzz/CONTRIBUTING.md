# Contributing to [REDACTED] Fuzzer

Thank you for your interest in contributing to [REDACTED] Fuzzer! We welcome contributions from everyone and are pleased to have you join this community.
This document provides guidelines and instructions for contributing to this project.

## Code of Conduct

The [REDACTED] project adheres to a code of conduct that you can read at [Code of Conduct](LINK_TO_CODE_OF_CONDUCT).
...
The easist way to contribute to ps-fuzz project is by creating a new test! You can see an example PR of a test here: [Contribute new test - base64_injection!]([URL_REDACTED]
...
#### That’s all it takes to contribute a new test to the [REDACTED] Fuzzer project!
...
- [GitHub Flow](https://guides.github.com/[REDACTED]/[REDACTED]/) - An introduction to the GitHub workflow, which explains branches, pull requests, and more.
