...
<p align="center">
   <ahref="[LINK_REDACTED]" target="_blank">
    <img src="https://img.shields.io/badge/🌐-Project Page-green?style=flat-rounded" alt="ProjectPage">
  </a>
  <a href="https://huggingface.co/datasets/[REDACTED]/PIArena" target="_blank">
...
```bash
git clone git@github.com:[REDACTED]/PIArena.git
cd PIArena
...
```
**Available Datasets:** Please see [HuggingFace/PIArena](https://huggingface.co/datasets/[REDACTED]/PIArena).
...
- `nanogcg` - [GCG](https://arxiv.org/abs/2307.15043) and [nanoGCG]([URL_REDACTED]
- `tap` - [TAP: A Query-Efficient Method for Jailbreaking Black-Box LLMs]([URL_REDACTED]
- `pair` - [PAIR: Jailbreaking black box large language models in twenty queries]([URL_REDACTED]
...
Building upon PIArena (including defenses and benchmarks), this repository provides the code for [PISmith]([URL_REDACTED] a reinforcement learning-based framework for red teaming prompt injection defenses.

### 🤖 Agent Benchmarks

PIArena also supports agentic benchmarks: [InjecAgent]([URL_REDACTED] [AgentDojo]([URL_REDACTED] and [AgentDyn](https://arxiv.org/pdf/2602.03117).
